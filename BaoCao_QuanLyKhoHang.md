...
| BCE | Boundary - Control - Entity: mẫu phân tách lớp giao diện - điều khiển - thực thể |
| CSDL | Cơ sở dữ liệu |
| QTV | Quản trị viên |
| QL kho | Quản lý kho |
...
Ngoài phạm vi: hệ thống **không** quản lý danh mục khách hàng (phiếu xuất chỉ ghi lý do xuất / ghi chú người nhận), không xử lý kế toán - hóa đơn.
...
Hệ thống phục vụ nghiệp vụ kho gồm: quản lý danh mục (tài khoản, nhà cung cấp, hàng hóa, kho), nhập / xuất kho, kiểm kê và báo cáo tồn. Mỗi danh mục và mỗi loại phiếu đều tách đủ năm thao tác Thêm / Sửa / Xóa / Tìm kiếm / Xem danh sách. Hệ thống **không** có phân hệ khách hàng. Bảng 2.1 ánh xạ nghiệp vụ với các use case sẽ phân tích ở Chương 3.
...
**Mô tả**: Nhân viên lập phiếu xuất từ một kho, ghi lý do xuất / ghi chú người nhận (hệ thống **không** quản lý danh mục khách hàng). Khi thêm dòng hàng, hệ thống kiểm tra tồn đủ; quản lý duyệt thì tồn kho mới **giảm**. Đủ các thao tác lập / sửa / xóa / tìm kiếm / xem danh sách.
...
![Hình 2.1: Biểu đồ hoạt động nghiệp vụ nhập kho](diagram/png/2.1_activity_nhapkho.png)
...
![Hình 2.2: Biểu đồ hoạt động nghiệp vụ xuất kho](diagram/png/2.2_activity_xuatkho.png)

Hình 2.2 tương tự nhập kho nhưng gắn nghiệp vụ xuất hàng: lập phiếu, chọn kho, nhập lý do / ghi chú người nhận (không có danh mục khách hàng), thêm dòng hàng. Khác biệt chính: điểm quyết định thứ nhất là **tồn kho đủ?** - hệ thống chặn xuất vượt tồn; khi duyệt, tồn kho **giảm**.

### 2.11.3. Nghiệp vụ kiểm kê

![Hình 2.3: Biểu đồ hoạt động nghiệp vụ kiểm kê](diagram/png/2.3_activity_kiemke.png)
...
Chương 2 đã mô tả **8 nghiệp vụ** kho của doanh nghiệp (không có phân hệ khách hàng), ánh xạ từng nghiệp vụ tới các use case (Bảng 2.1) và minh họa ba nghiệp vụ chính bằng biểu đồ hoạt động (Hình 2.1 - 2.3). Đây là đầu vào cho ba giai đoạn phân tích: chức năng (Chương 3), cấu trúc (Chương 4) và hành vi (Chương 5).
...
- **Các oval** là nhóm chức năng mức tổng quát: Đăng nhập / Đăng xuất, Quản lý tài khoản, NCC, hàng hóa, kho, Nhập kho, Xuất kho, Kiểm kê, Báo cáo NXT - không có nhóm khách hàng. Đây chưa phải use case chi tiết.
...
Hình 3.2 gồm: (1) hai use case **hệ thống** UC01 Đăng nhập, UC02 Đăng xuất dành cho mọi người dùng; (2) năm use case quản trị tài khoản UC03 - UC07 chỉ dành cho Quản trị viên, theo nguyên tắc "mỗi hành động một use case". Các use case quản trị đều «include» UC01 (phải đăng nhập trước).

### 3.5.2. Nhóm đối tác

![Hình 3.3: Biểu đồ use case phân rã nhóm đối tác](diagram/png/3.3_usecase_ncc.png)

Hình 3.3 phân rã nhóm nhà cung cấp thành đủ năm mục tiêu UC08 - UC12 (Thêm / Sửa / Xóa / Tìm kiếm / Xem danh sách); quan hệ «include» tới UC01 thể hiện điều kiện đăng nhập. Không có use case khách hàng. Nhân viên kho và Quản lý kho đều thao tác được các use case NCC.
...
Bảng 3.3 đặc tả use case UC01; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.1, mục 5.1.1).
...
| Điều kiện trước | Người dùng đã được cấp tài khoản, tài khoản đang hoạt động, chưa có phiên làm việc. |
...
Bảng 3.4 đặc tả use case UC02; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.2, mục 5.1.2).
...
| Điều kiện trước | Người dùng đã đăng nhập thành công (đang có phiên hợp lệ). |
...
Bảng 3.5 đặc tả use case UC03; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.3, mục 5.1.3).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Quản trị viên). |
...
Bảng 3.6 đặc tả use case UC04; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.4, mục 5.1.4).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Quản trị viên). Đã tồn tại bản ghi cần thao tác (chọn từ danh sách hoặc kết quả tìm kiếm). |
...
Bảng 3.7 đặc tả use case UC05; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.5, mục 5.1.5).
...
Bảng 3.8 đặc tả use case UC06; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.6, mục 5.1.6).
...
Bảng 3.9 đặc tả use case UC07; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.7, mục 5.1.7).
...
Bảng 3.10 đặc tả use case UC08; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.8, mục 5.1.8).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Nhân viên kho, Quản lý kho). |
...
Bảng 3.11 đặc tả use case UC09; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.9, mục 5.1.9).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Nhân viên kho, Quản lý kho). Đã tồn tại bản ghi cần thao tác (chọn từ danh sách hoặc kết quả tìm kiếm). |
...
Bảng 3.12 đặc tả use case UC10; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.10, mục 5.1.10).
...
Bảng 3.13 đặc tả use case UC11; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.11, mục 5.1.11).
...
Bảng 3.14 đặc tả use case UC12; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.12, mục 5.1.12).
...
Bảng 3.15 đặc tả use case UC13; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.13, mục 5.1.13).
...
Bảng 3.16 đặc tả use case UC14; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.14, mục 5.1.14).
...
Bảng 3.17 đặc tả use case UC15; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.15, mục 5.1.15).
...
Bảng 3.18 đặc tả use case UC16; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.16, mục 5.1.16).
...
Bảng 3.19 đặc tả use case UC17; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.17, mục 5.1.17).
...
Bảng 3.20 đặc tả use case UC18; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.18, mục 5.1.18).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Quản lý kho). |
...
Bảng 3.21 đặc tả use case UC19; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.19, mục 5.1.19).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Quản lý kho). Đã tồn tại bản ghi cần thao tác (chọn từ danh sách hoặc kết quả tìm kiếm). |
...
Bảng 3.22 đặc tả use case UC20; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.20, mục 5.1.20).
...
Bảng 3.23 đặc tả use case UC21; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.21, mục 5.1.21).
...
Bảng 3.24 đặc tả use case UC22; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.22, mục 5.1.22).
...
Bảng 3.25 đặc tả use case UC23; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.23, mục 5.1.23).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Nhân viên kho, Quản lý kho). Danh mục nhà cung cấp, kho, hàng hóa đã có dữ liệu. |
...
Bảng 3.26 đặc tả use case UC24; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.24, mục 5.1.24).
...
Bảng 3.27 đặc tả use case UC25; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.25, mục 5.1.25).
...
Bảng 3.28 đặc tả use case UC26; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.26, mục 5.1.26).
...
Bảng 3.29 đặc tả use case UC27; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.27, mục 5.1.27).
...
Bảng 3.30 đặc tả use case UC28; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.28, mục 5.1.28).
...
| Tác nhân chính | Nhân viên kho, Quản lý kho |
| Mô tả tóm tắt | Nhân viên kho tạo phiếu xuất (kho, lý do xuất / ghi chú người nhận - không quản lý danh mục khách hàng); hệ thống kiểm tra tồn đủ; duyệt mới giảm tồn. |
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Nhân viên kho, Quản lý kho). Danh mục kho, hàng hóa đã có dữ liệu; kho còn tồn. |
...
Bảng 3.31 đặc tả use case UC29; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.29, mục 5.1.29).
...
Bảng 3.32 đặc tả use case UC30; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.30, mục 5.1.30).
...
Bảng 3.33 đặc tả use case UC31; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.31, mục 5.1.31).
...
Bảng 3.34 đặc tả use case UC32; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.32, mục 5.1.32).
...
Bảng 3.35 đặc tả use case UC33; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.33, mục 5.1.33).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Nhân viên kho (lập), Quản lý kho (duyệt)). Kho cần kiểm kê đã có dữ liệu tồn. |
...
Bảng 3.36 đặc tả use case UC34; luồng sự kiện chính đánh số khớp với các thông điệp trên biểu đồ trình tự tương ứng (Hình 5.34, mục 5.1.34).
...
| Điều kiện trước | Đã đăng nhập (UC01) với vai trò phù hợp (Quản lý kho). Đã phát sinh phiếu nhập / xuất được duyệt trong kỳ. |
...
| PhieuXuatKho | Phiếu xuất kho (không gắn khách hàng) | UC28 - UC32 |
...
Hình 4.2 mô tả cấu trúc **giao dịch** dạng master - detail: PhieuNhapKho gắn NhaCungCap, Kho, NguoiDung (người lập) và có nhiều ChiTietPhieuNhap; mỗi chi tiết trỏ một HangHoa. PhieuXuatKho đối xứng nhưng không gắn NCC / khách hàng - chỉ có LyDoXuat, GhiChu. TonKho liên kết Kho - HangHoa, là lớp bị cập nhật bởi hành vi duyệt phiếu (thể hiện rõ ở biểu đồ trình tự Chương 5).
...
Thay vì vẽ lặp biểu đồ lớp cho từng use case CRUD (năm use case cùng nhóm dùng chung một tập lớp), phần này **cắt lát theo nhóm entity**: mỗi nhóm chức năng một biểu đồ lớp gồm boundary - control - entity. Các use case cùng nhóm chia sẻ cấu trúc lớp; khác biệt nằm ở **phương thức** được gọi (thêm / sửa / xóa / tìm / xem) và thể hiện ở biểu đồ trình tự (Chương 5). Bảng 4.2 ánh xạ nhóm entity với use case.
...
Hình 4.9: đối xứng nhóm phiếu nhập nhưng không có NhaCungCap / khách hàng; TonKho tham gia hai vai: kiểm tra đủ tồn (kiemTraDu) khi thêm dòng hàng và trừ tồn (giamTon) khi duyệt.
...
| PhieuXuatKho | MaPhieuXuat, MaKho, MaNguoiDung, NgayXuat, LyDoXuat, GhiChu, TongTien, TrangThai | Không có MaKhachHang |
...
**Nguyên tắc**: mỗi use case đã đặc tả ở mục 3.7 (UC01 - UC34) có đúng **một** biểu đồ trình tự. Các biểu đồ dùng chung mẫu lifeline boundary - control - entity: tác nhân thao tác trên lớp giao diện ManHinh..., lớp điều khiển DieuKhien... tiếp nhận yêu cầu và gọi các lớp thực thể (đúng tên lớp và phương thức đã khai báo ở Chương 4). Thông điệp nét liền là lời gọi (đánh số khớp các bước luồng chính trong đặc tả); nét đứt là phản hồi. Các use case CRUD cùng entity khác nhau chủ yếu ở tên phương thức và ràng buộc (xóa hay ngừng, kiểm tra tồn, trạng thái phiếu...).

### 5.1.1. UC01 - Đăng nhập

![Hình 5.1: Biểu đồ trình tự UC01 - Đăng nhập](diagram/png/5.01_sequence_uc01.png)

Hình 5.1 thể hiện luồng xử lý use case UC01 theo mẫu boundary - control - entity: Tất cả người dùng thao tác trên ManHinhDangNhap; DieuKhienXacThuc tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NguoiDung. 4 thông điệp đánh số trên biểu đồ khớp 4 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.1 (Bảng 3.3).
...
Hình 5.2 thể hiện luồng xử lý use case UC02 theo mẫu boundary - control - entity: Tất cả người dùng thao tác trên ManHinhDangNhap; DieuKhienXacThuc tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NguoiDung. 4 thông điệp đánh số trên biểu đồ khớp 4 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.2 (Bảng 3.4).

### 5.1.3. UC03 - Thêm tài khoản

![Hình 5.3: Biểu đồ trình tự UC03 - Thêm tài khoản](diagram/png/5.03_sequence_uc03.png)

Hình 5.3 thể hiện luồng xử lý use case UC03 theo mẫu boundary - control - entity: Quản trị viên thao tác trên ManHinhTaiKhoan; DieuKhienTaiKhoan tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NguoiDung. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.3 (Bảng 3.5).

### 5.1.4. UC04 - Sửa tài khoản

![Hình 5.4: Biểu đồ trình tự UC04 - Sửa tài khoản](diagram/png/5.04_sequence_uc04.png)

Hình 5.4 thể hiện luồng xử lý use case UC04 theo mẫu boundary - control - entity: Quản trị viên thao tác trên ManHinhTaiKhoan; DieuKhienTaiKhoan tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NguoiDung. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.4 (Bảng 3.6).

### 5.1.5. UC05 - Xóa tài khoản

![Hình 5.5: Biểu đồ trình tự UC05 - Xóa tài khoản](diagram/png/5.05_sequence_uc05.png)

Hình 5.5 thể hiện luồng xử lý use case UC05 theo mẫu boundary - control - entity: Quản trị viên thao tác trên ManHinhTaiKhoan; DieuKhienTaiKhoan tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NguoiDung. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.5 (Bảng 3.7).
...
Hình 5.6 thể hiện luồng xử lý use case UC06 theo mẫu boundary - control - entity: Quản trị viên thao tác trên ManHinhTaiKhoan; DieuKhienTaiKhoan tiếp nhận yêu cầu và điều phối các lớp thực thể NguoiDung. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.6 (Bảng 3.8).

### 5.1.7. UC07 - Xem danh sách tài khoản

![Hình 5.7: Biểu đồ trình tự UC07 - Xem danh sách tài khoản](diagram/png/5.07_sequence_uc07.png)

Hình 5.7 thể hiện luồng xử lý use case UC07 theo mẫu boundary - control - entity: Quản trị viên thao tác trên ManHinhTaiKhoan; DieuKhienTaiKhoan tiếp nhận yêu cầu và điều phối các lớp thực thể NguoiDung. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.7 (Bảng 3.9).

### 5.1.8. UC08 - Thêm nhà cung cấp

![Hình 5.8: Biểu đồ trình tự UC08 - Thêm nhà cung cấp](diagram/png/5.08_sequence_uc08.png)

Hình 5.8 thể hiện luồng xử lý use case UC08 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhNhaCungCap; DieuKhienNhaCungCap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NhaCungCap. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.8 (Bảng 3.10).

### 5.1.9. UC09 - Sửa nhà cung cấp

![Hình 5.9: Biểu đồ trình tự UC09 - Sửa nhà cung cấp](diagram/png/5.09_sequence_uc09.png)

Hình 5.9 thể hiện luồng xử lý use case UC09 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhNhaCungCap; DieuKhienNhaCungCap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NhaCungCap. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.9 (Bảng 3.11).

### 5.1.10. UC10 - Xóa nhà cung cấp

![Hình 5.10: Biểu đồ trình tự UC10 - Xóa nhà cung cấp](diagram/png/5.10_sequence_uc10.png)

Hình 5.10 thể hiện luồng xử lý use case UC10 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhNhaCungCap; DieuKhienNhaCungCap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, NhaCungCap. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.10 (Bảng 3.12).
...
Hình 5.11 thể hiện luồng xử lý use case UC11 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhNhaCungCap; DieuKhienNhaCungCap tiếp nhận yêu cầu và điều phối các lớp thực thể NhaCungCap. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.11 (Bảng 3.13).

### 5.1.12. UC12 - Xem danh sách nhà cung cấp

![Hình 5.12: Biểu đồ trình tự UC12 - Xem danh sách nhà cung cấp](diagram/png/5.12_sequence_uc12.png)

Hình 5.12 thể hiện luồng xử lý use case UC12 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhNhaCungCap; DieuKhienNhaCungCap tiếp nhận yêu cầu và điều phối các lớp thực thể NhaCungCap. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.12 (Bảng 3.14).

### 5.1.13. UC13 - Thêm hàng hóa

![Hình 5.13: Biểu đồ trình tự UC13 - Thêm hàng hóa](diagram/png/5.13_sequence_uc13.png)

Hình 5.13 thể hiện luồng xử lý use case UC13 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhHangHoa; DieuKhienHangHoa tiếp nhận yêu cầu và điều phối các lớp thực thể HangHoa, LichSuThaoTac, TonKho. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.13 (Bảng 3.15).
...
Hình 5.14 thể hiện luồng xử lý use case UC14 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhHangHoa; DieuKhienHangHoa tiếp nhận yêu cầu và điều phối các lớp thực thể HangHoa, LichSuThaoTac. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.14 (Bảng 3.16).

### 5.1.15. UC15 - Xóa hàng hóa

![Hình 5.15: Biểu đồ trình tự UC15 - Xóa hàng hóa](diagram/png/5.15_sequence_uc15.png)

Hình 5.15 thể hiện luồng xử lý use case UC15 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhHangHoa; DieuKhienHangHoa tiếp nhận yêu cầu và điều phối các lớp thực thể HangHoa, LichSuThaoTac. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.15 (Bảng 3.17).
...
Hình 5.16 thể hiện luồng xử lý use case UC16 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhHangHoa; DieuKhienHangHoa tiếp nhận yêu cầu và điều phối các lớp thực thể HangHoa, TonKho. 4 thông điệp đánh số trên biểu đồ khớp 4 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.16 (Bảng 3.18).
...
Hình 5.17 thể hiện luồng xử lý use case UC17 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhHangHoa; DieuKhienHangHoa tiếp nhận yêu cầu và điều phối các lớp thực thể HangHoa. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.17 (Bảng 3.19).

### 5.1.18. UC18 - Thêm kho

![Hình 5.18: Biểu đồ trình tự UC18 - Thêm kho](diagram/png/5.18_sequence_uc18.png)

Hình 5.18 thể hiện luồng xử lý use case UC18 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhKho; DieuKhienKho tiếp nhận yêu cầu và điều phối các lớp thực thể Kho, LichSuThaoTac. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.18 (Bảng 3.20).

### 5.1.19. UC19 - Sửa kho

![Hình 5.19: Biểu đồ trình tự UC19 - Sửa kho](diagram/png/5.19_sequence_uc19.png)

Hình 5.19 thể hiện luồng xử lý use case UC19 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhKho; DieuKhienKho tiếp nhận yêu cầu và điều phối các lớp thực thể Kho, LichSuThaoTac. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.19 (Bảng 3.21).

### 5.1.20. UC20 - Xóa kho

![Hình 5.20: Biểu đồ trình tự UC20 - Xóa kho](diagram/png/5.20_sequence_uc20.png)

Hình 5.20 thể hiện luồng xử lý use case UC20 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhKho; DieuKhienKho tiếp nhận yêu cầu và điều phối các lớp thực thể Kho, LichSuThaoTac. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.20 (Bảng 3.22).
...
Hình 5.21 thể hiện luồng xử lý use case UC21 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhKho; DieuKhienKho tiếp nhận yêu cầu và điều phối các lớp thực thể Kho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.21 (Bảng 3.23).

### 5.1.22. UC22 - Xem danh sách kho

![Hình 5.22: Biểu đồ trình tự UC22 - Xem danh sách kho](diagram/png/5.22_sequence_uc22.png)

Hình 5.22 thể hiện luồng xử lý use case UC22 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhKho; DieuKhienKho tiếp nhận yêu cầu và điều phối các lớp thực thể Kho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.22 (Bảng 3.24).

### 5.1.23. UC23 - Lập phiếu nhập kho

![Hình 5.23: Biểu đồ trình tự UC23 - Lập phiếu nhập kho](diagram/png/5.23_sequence_uc23.png)

Hình 5.23 thể hiện luồng xử lý use case UC23 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuNhap; DieuKhienPhieuNhap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuNhapKho, TonKho. 11 thông điệp đánh số trên biểu đồ khớp 11 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.23 (Bảng 3.25).
...
Hình 5.24 thể hiện luồng xử lý use case UC24 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuNhap; DieuKhienPhieuNhap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuNhapKho. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.24 (Bảng 3.26).
...
Hình 5.25 thể hiện luồng xử lý use case UC25 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuNhap; DieuKhienPhieuNhap tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuNhapKho. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.25 (Bảng 3.27).
...
Hình 5.26 thể hiện luồng xử lý use case UC26 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuNhap; DieuKhienPhieuNhap tiếp nhận yêu cầu và điều phối các lớp thực thể PhieuNhapKho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.26 (Bảng 3.28).

### 5.1.27. UC27 - Xem danh sách phiếu nhập

![Hình 5.27: Biểu đồ trình tự UC27 - Xem danh sách phiếu nhập](diagram/png/5.27_sequence_uc27.png)

Hình 5.27 thể hiện luồng xử lý use case UC27 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuNhap; DieuKhienPhieuNhap tiếp nhận yêu cầu và điều phối các lớp thực thể PhieuNhapKho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.27 (Bảng 3.29).

### 5.1.28. UC28 - Lập phiếu xuất kho

![Hình 5.28: Biểu đồ trình tự UC28 - Lập phiếu xuất kho](diagram/png/5.28_sequence_uc28.png)

Hình 5.28 thể hiện luồng xử lý use case UC28 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuXuat; DieuKhienPhieuXuat tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuXuatKho, TonKho. 12 thông điệp đánh số trên biểu đồ khớp 12 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.28 (Bảng 3.30).
...
Hình 5.29 thể hiện luồng xử lý use case UC29 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuXuat; DieuKhienPhieuXuat tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuXuatKho, TonKho. 7 thông điệp đánh số trên biểu đồ khớp 7 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.29 (Bảng 3.31).
...
Hình 5.30 thể hiện luồng xử lý use case UC30 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuXuat; DieuKhienPhieuXuat tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuXuatKho. 5 thông điệp đánh số trên biểu đồ khớp 5 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.30 (Bảng 3.32).
...
Hình 5.31 thể hiện luồng xử lý use case UC31 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuXuat; DieuKhienPhieuXuat tiếp nhận yêu cầu và điều phối các lớp thực thể PhieuXuatKho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.31 (Bảng 3.33).

### 5.1.32. UC32 - Xem danh sách phiếu xuất

![Hình 5.32: Biểu đồ trình tự UC32 - Xem danh sách phiếu xuất](diagram/png/5.32_sequence_uc32.png)

Hình 5.32 thể hiện luồng xử lý use case UC32 theo mẫu boundary - control - entity: Nhân viên kho, Quản lý kho thao tác trên ManHinhPhieuXuat; DieuKhienPhieuXuat tiếp nhận yêu cầu và điều phối các lớp thực thể PhieuXuatKho. 3 thông điệp đánh số trên biểu đồ khớp 3 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.32 (Bảng 3.34).

### 5.1.33. UC33 - Lập phiếu kiểm kê

![Hình 5.33: Biểu đồ trình tự UC33 - Lập phiếu kiểm kê](diagram/png/5.33_sequence_uc33.png)

Hình 5.33 thể hiện luồng xử lý use case UC33 theo mẫu boundary - control - entity: Nhân viên kho (lập), Quản lý kho (duyệt) thao tác trên ManHinhKiemKe; DieuKhienKiemKe tiếp nhận yêu cầu và điều phối các lớp thực thể LichSuThaoTac, PhieuKiemKe, TonKho. 14 thông điệp đánh số trên biểu đồ khớp 14 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.33 (Bảng 3.35).
...
Hình 5.34 thể hiện luồng xử lý use case UC34 theo mẫu boundary - control - entity: Quản lý kho thao tác trên ManHinhBaoCao; DieuKhienBaoCao tiếp nhận yêu cầu và điều phối các lớp thực thể PhieuNhapKho, PhieuXuatKho, TonKho. 6 thông điệp đánh số trên biểu đồ khớp 6 bước của luồng sự kiện chính trong đặc tả ở mục 3.7.34 (Bảng 3.36).
...
- **Giao diện người dùng (UI / Web Browser)**: các form đăng nhập, màn hình phiếu, danh mục - hiện thực hóa các lớp «boundary» ManHinh... ở phân tích.
...
Mũi tên từ trên xuống thể hiện chiều phụ thuộc: UI không gọi thẳng Database mà đi qua Controller, Service rồi Repository. Kiến trúc này khớp mẫu boundary - control - entity của biểu đồ trình tự (Chương 5) và đáp ứng NFR-04 về tính mở rộng.
...
- NhaCungCap 1 - n PhieuNhapKho; PhieuXuatKho **không** gắn khách hàng (chỉ LyDoXuat / GhiChu).
...
| PhieuXuatKho | Phiếu xuất: mã, kho, người lập, ngày, lý do, ghi chú, tổng tiền, trạng thái (không có khách hàng) |
...
| LyDoXuat, GhiChu | NVARCHAR | 500 | Chỉ phiếu xuất (không có MaKhachHang) |
