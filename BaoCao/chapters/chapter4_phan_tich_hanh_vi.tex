...
\hline
\textbf{Nhóm entity} & \textbf{Use case} & \textbf{Sequence (Ch.5)} \\
\hline
\endfirsthead
\hline
\textbf{Nhóm entity} & \textbf{Use case} & \textbf{Sequence (Ch.5)} \\
\hline
\endhead
Tài khoản / xác thực & UC01--UC07 & UC01--UC07 (đủ) \\
\hline
Nhà cung cấp & UC08--UC12 & UC08--UC12 (đủ) \\
\hline
Hàng hóa & UC13--UC17 & UC13--UC17 (đủ) \\
\hline
Kho & UC18--UC22 & UC18--UC22 (đủ) \\
\hline
Phiếu nhập & UC23--UC27 & UC23--UC27 (đủ) \\
\hline
Phiếu xuất & UC28--UC32 & UC28--UC32 (đủ) \\
\hline
Kiểm kê & UC33 & UC33 \\
\hline
...
Mỗi use case có \textbf{một} biểu đồ trình tự tương ứng ở Ch.5 (tổng 34 sequence).
...
\input{diagrams/tex/4.7_class_ncc}
...
\input{diagrams/tex/4.8_class_kho}
...
\input{diagrams/tex/4.9_class_kiemke}
...
\input{diagrams/tex/4.10_class_baocao}
